...
if [[ $task == "objectnav" ]]; then
    ...
    python psiturk_dataset/parsing/parse_objectnav_dataset.py --replay-path data/hit_data/visualisation/unapproved_hits  --output-path data/datasets/objectnav_mp3d_v4/human_val/content/
    python examples/objectnav_replay.py --replay-episode data/datasets/objectnav_mp3d_v4/human_val/human_val.json.gz --step-env --output-prefix $prefix
else
