...
if [[ $task == "objectnav" ]]; then
    ...
    # Generate replays
    python psiturk_dataset/parsing/parse_objectnav_dataset.py --replay-path data/hit_data/visualisation/unapproved_hits  --output-path data/datasets/objectnav_gibson_v2/train/content --gibson
