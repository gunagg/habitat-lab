...
if [[ $task == "objectnav" ]]; then
    ...
    # Append to dataset
    # python psiturk_dataset/parsing/parse_objectnav_dataset.py --replay-path data/hit_data/visualisation/unapproved_hits  --output-path data/datasets/objectnav_mp3d/objectnav_mp3d_35k/train/content/ --append-dataset
    # Generate replays
    ...
    python examples/objectnav_replay.py --replay-episode data/datasets/objectnav_mp3d_v4/human_val_full/human_val_full.json.gz --step-env --output-prefix $prefix  --metrics
else
