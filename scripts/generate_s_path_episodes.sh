...
if [[ $task == "objectnav" ]]; then
    ...
    python psiturk_dataset/generator/objectnav_shortest_path_generator.py --episodes data/datasets/objectnav_mp3d_v4/train/train.json.gz --scene $sceneId --split $path
else
