...
# -----------------------------------------------------------------------------
_C.IL = CN()
_C.IL.OBS_TRANSFORMS = CN()
_C.IL.OBS_TRANSFORMS.ENABLED_TRANSFORMS = tuple()

# -----------------------------------------------------------------------------
# OBS_AUGMENTATION CONFIG
# -----------------------------------------------------------------------------
_C.IL.OBS_AUGMENTATIONS = ""
_C.IL.OBS_AUGMENTATIONS_PARAMS = CN()
_C.IL.OBS_AUGMENTATIONS_PARAMS.same_on_batch = True
_C.IL.OBS_AUGMENTATIONS_PARAMS.GRAYSCALE = CN()
_C.IL.OBS_AUGMENTATIONS_PARAMS.GRAYSCALE.gray_p = 0.3
_C.IL.OBS_AUGMENTATIONS_PARAMS.RANDOM_ROTATION = CN()
_C.IL.OBS_AUGMENTATIONS_PARAMS.RANDOM_ROTATION.rotation_degrees = 5.0
_C.IL.OBS_AUGMENTATIONS_PARAMS.RANDOM_ROTATION.rotation_p = 1.0
_C.IL.OBS_AUGMENTATIONS_PARAMS.RANDOM_RESIZED_CROP = CN()
_C.IL.OBS_AUGMENTATIONS_PARAMS.RANDOM_RESIZED_CROP.crop_p = 0.3
_C.IL.OBS_AUGMENTATIONS_PARAMS.RANDOM_RESIZED_CROP.crop_size = 256
_C.IL.OBS_AUGMENTATIONS_PARAMS.RANDOM_RESIZED_CROP.crop_scale = 0.8
_C.IL.OBS_AUGMENTATIONS_PARAMS.RANDOM_RESIZED_CROP.crop_ratio = 1.0
_C.IL.OBS_AUGMENTATIONS_PARAMS.COLOR_JITTER = CN()
_C.IL.OBS_AUGMENTATIONS_PARAMS.COLOR_JITTER.color_p = 1.0
_C.IL.OBS_AUGMENTATIONS_PARAMS.COLOR_JITTER.brightness = 0.4
_C.IL.OBS_AUGMENTATIONS_PARAMS.COLOR_JITTER.contrast = 0.4
_C.IL.OBS_AUGMENTATIONS_PARAMS.COLOR_JITTER.saturation = 0.4
_C.IL.OBS_AUGMENTATIONS_PARAMS.COLOR_JITTER.hue = 0.5
_C.IL.OBS_AUGMENTATIONS_PARAMS.TRANSLATE = CN()
_C.IL.OBS_AUGMENTATIONS_PARAMS.TRANSLATE.pad = 4
_C.IL.OBS_AUGMENTATIONS_PARAMS.TRANSLATE.crop_p = 1.0
_C.IL.OBS_AUGMENTATIONS_PARAMS.TRANSLATE.crop_size = 256
# -----------------------------------------------------------------------------
# REINFORCEMENT LEARNING (RL) ENVIRONMENT CONFIG
# -----------------------------------------------------------------------------
_C.RL = CN()
