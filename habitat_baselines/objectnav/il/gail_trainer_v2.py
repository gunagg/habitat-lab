...
class GAILTrainer(BaseRLTrainer):
    ...
    def _init_train(self):
        ...
        self.expert_rollouts = RolloutStorage(
            ppo_cfg.num_steps,
            self.envs.num_envs,
            obs_space,
            self.policy_action_space,
        ...
        self.expert_rollouts.to(self.device)
    ...
    def _compute_expert_actions_and_step_envs(self, buffer_index: int = 0):
        ...
        next_actions = self.rollouts.get_next_actions()
